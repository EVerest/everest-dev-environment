...
_shtab_edm_tool_option_strings=('-h' '--help' '--version' '--workspace' '--working_dir' '--out' '--include_deps' '--config' '--create-vscode-workspace' '--update' '--cmake' '--verbose' '--nocolor' '--register-cmake-module' '--install-bash-completion' '--create-config' '--external-in-config' '--include-remotes' '--git-info' '--git-fetch' '--git-pull')
...
_shtab_edm_tool___register_cmake_module_nargs=0
